    ...
    <div class="content-wrapper">
        <div class="col-md-7 py-5 mx-auto">
            <div class="card card-primary card-outline">
                <div class="card-header text-center">{{ __('Edit Subscription') }}</div>
                <div class="card-body">
                    ...
                    <form action="{{ route('subscriptions.update', $subscription->id) }}" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="email" required class="form-control" name="email" value="{{ old('email', $subscription->email) }}" placeholder="Enter email">
                            </div>
                        </div>
